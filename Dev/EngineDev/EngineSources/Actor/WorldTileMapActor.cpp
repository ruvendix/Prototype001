...
WorldTileMapActor::~WorldTileMapActor()
{
	...
	writeWorldTileMapFileStream.OpenFileStream("Assets/WorldTileMap/Hyrule.wtm", EFileStreamMode::WriteOnlyBinary);
...
void WorldTileMapActor::Startup()
{
	...
	readWorldTileMapFileStream.OpenFileStream("Assets/WorldTileMap/Hyrule.wtm", EFileStreamMode::ReadOnlyBinary);
...
{
	const Position2d& currentMousePos = InputDeviceMananger::I()->GetMouseDevice()->GetCurrentMousePosition();
